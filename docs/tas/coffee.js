...
Engine.prototype = {
		...
		if(!this.control.paused) {
			...
			case 1:
				if(this.fps >= 58 && this.fps <= 62) {
					...
					window.setTimeout(wrappedCallback,null,this.frameLength);
				}
				break;
			default:
	...
	,resetLevel: function(slot,replay) {
		...
		},null,this.control.speed == 0 ? 100 : this.frameLength);
